...
<div class="container">
  <header class="blog-header lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center"><a class="blog-header-logo text-dark" href="#">๋Jewelry</a>
      </div>
      <div class="col-4 d-flex justify-content-end align-items-center"><a class="btn btn-sm btn-outline-secondary" href="logout.php">Logout</a>
      </div>
    </div>
  </header>
<div class="nav-scroller py-1 mb-2 text-center">
    <nav class="nav d-flex justify-content-between">
     <a href="allproduct.php" class="btn btn-outline-dark">สินค้า</a>
    </nav>
  </div>
</div>

<main class="container">
<img src="../images/ปก.jpg">
</div>
